...
// /**
//  * Props for `TalkWhatsapp`.
//  */
// export type TalkWhatsappProps = SliceComponentProps<Content.TalkWhatsappSlice>;

// /**
//  * Component for "TalkWhatsapp" Slices.
//  */
      ...
      <Bounded yPadding="base" className="relative">
        <div className="mx-auto w-full max-w-[590px]">
            ...
            <div className=' flex flex-row justify-center items-center'>
              ...
              <PrismicNextLink field={slice?.primary?.calltoactionlink} target="_blank" rel="noopener noreferrer nofollow">
                <address className="not-italic ml-4 mb-5">
                  <a
                    href={`tel:${slice?.primary?.phone}`}
                    className="text-heading-4 font-bold -tracking-[1.6px] text-[#c39f77] hover:underline lg:text-heading-2 xl:text-[48px] xl:leading-[1.12]"
                  >
                    {slice.primary.phone}
                  </a>
                </address>
